...
//         <Grid container>
//             <Grid item xs={5}>
//             <img style={{ width: "35px" ,marginLeft:"80px"}} src={cplogo}/>
//             <img style={{ width: "30px" ,marginLeft:"20px"}} src={lens}/>
//             </Grid> 
//             <Grid item xs={7}>
...
//             currentUserName:userData._document?.data?.value.mapValue.fields.username.stringValue}}><img style={{ width: "30px" ,marginLeft:"50px" }} src={network}/></Link>
//             <img style={{ width: "30px" ,marginLeft:"50px"}} src={message}/>
//             <img style={{ width: "30px" ,marginLeft:"50px",borderRadius:"40px"}} src={userData._document?.data?.value.mapValue.fields.profile_image.stringValue ?? profile}/>
//             </Grid>
//         </Grid>
//     </div>
//   )
